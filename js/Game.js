...
if(cars[index-1].collide(obstacles)){
  ...
  showRank() {
    swal({
      ...
      text: "WOOHOO!,GJJJJ!",
      imageUrl:
        "https://media.discordapp.net/attachments/839796682194812978/914893275083714640/n8zJ3qeSV1nfQAAAABJRU5ErkJggg.png",
      imageSize: "100x100",
  ...
  gameOver() {
    swal({
      ...
      imageUrl:
      "https://cdn.discordapp.com/attachments/839796682194812978/914895007067029534/dbgZZVUw4jEAAAAASUVORK5CYII.png",     
       imageSize: "100x100",
